...
run_mcmc() {
  ...
  cplate_summarise_mcmc --null --chrom $chrom --mmap $config
  # Run hyperparameter summaries
  cplate_summarise_params_mcmc --null --chrom $chrom $config
  # Run cluster level summaries
  cplate_summarise_clusters_mcmc --null --chrom $chrom $config
}
